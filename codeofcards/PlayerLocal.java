...
//        
//    }
//    PlayerLocal(int id, String name, Game game, Socket playerSocket) throws IOException {
//        this.id = id;
//        this.name = name;
//        this.life = 30;
//        this.game = game;
...
//    }
//
//    public void turn(ArrayList<PlayerLocal> playerList) {
...
//
//        while(actionsDone < 3){
//            for (PlayerLocal players : playerList) {
...
//                    PlayerLocal other = this.choosePlayer(playerList);
...
//    }
//
//    public PlayerLocal choosePlayer(ArrayList<PlayerLocal> playerList) {
...
//    }
//    
//    void playCard(int cardIndex, PlayerLocal other) { // Directplay (not lay card in a function on the table)
...
//    }
//
//    public void executeFunction(PlayerLocal other) {
